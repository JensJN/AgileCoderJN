...
# then run in terminal:
    ...
    # docker run -td --rm --name container_agilecoder --env API_KEY_PATH=$API_KEY_PATH --volume $(pwd)/agilecoderapp:/root --volume $API_KEY_PATH:$API_KEY_PATH image_agilecoder
